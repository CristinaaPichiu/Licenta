    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        try {
            ...
            String messageBody = "<div style='font-family: Arial, sans-serif; color: #333;'>"
                    ...
                    + "<strong>SkillMap</strong> is designed to help you create professional resumes and cover letters, "
                    + "track your job applications and search for new job opportunities.</p>"
